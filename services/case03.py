...
INSTRUMENT_OPTIONS = [
    "Trái phiếu doanh nghiệp token hóa",
    "Cổ phần token hóa",
    "Chứng chỉ quỹ token hóa",
    "Gọi vốn cộng đồng bằng token",
    "Token đại diện cho khoản phải thu",
...
RISK_DEFAULT = [
    ("Rủi ro tín dụng", "Doanh nghiệp không tạo đủ dòng tiền để thực hiện nghĩa vụ", 3, 5, "Công bố DSCR, LTV; giới hạn phát hành; giám sát dòng tiền", "FutureBank/Doanh nghiệp"),
    ("Rủi ro thị trường", "Giá trị tài sản hoặc token biến động", 3, 4, "Công bố biến động; giới hạn nhà đầu tư", "Doanh nghiệp"),
    ("Rủi ro thanh khoản", "Không có thị trường thứ cấp đủ sâu", 4, 4, "Hạn chế quảng bá thanh khoản; cơ chế mua lại rõ ràng", "Đơn vị phát hành"),
    ("Rủi ro định giá", "Giá phát hành không phản ánh hợp lý tài sản cơ sở", 3, 4, "Thẩm định độc lập và công bố phương pháp định giá", "Đơn vị phát hành"),
    ("Rủi ro thông tin", "Thông tin dự án không đầy đủ hoặc không kịp thời", 3, 5, "Công bố định kỳ; kiểm toán; nhật ký trên nền tảng", "Doanh nghiệp"),
    ("Rủi ro pháp lý", "Quyền pháp lý của token hoặc cấu trúc phát hành chưa rõ", 2, 5, "Rà soát pháp lý trước phát hành", "FutureBank/Pháp chế"),
    ("Rủi ro hợp đồng thông minh", "Lỗi logic phát hành hoặc chuyển nhượng", 3, 5, "Kiểm toán độc lập; kiểm thử; quyền tạm dừng", "Đơn vị phát triển"),
    ("Rủi ro Oracle", "Dữ liệu tài sản hoặc sự kiện bên ngoài sai", 3, 5, "Nguồn kép; đối chiếu; quy trình xử lý sai lệch", "Nhà cung cấp Oracle"),
    ("Rủi ro lưu ký", "Tài sản hoặc khóa được lưu ký không an toàn", 2, 5, "Tách biệt tài sản; kiểm soát truy cập; kiểm toán", "Đơn vị lưu ký"),
    ("Rủi ro mất khóa", "Nhà đầu tư mất khóa riêng", 2, 5, "Cơ chế khôi phục hoặc lưu ký bên thứ ba", "Nhà đầu tư/Đơn vị lưu ký"),
    ("Rủi ro quản trị", "Quyền nâng cấp hoặc tạm dừng tập trung", 3, 4, "Đa chữ ký; phê duyệt nhiều bên", "Hội đồng quản trị mạng"),
    ("Rủi ro xuyên biên giới", "Khác biệt quy định giữa các thị trường", 2, 4, "Giới hạn khu vực và rà soát pháp lý", "FutureBank/Pháp chế"),
    ("Rủi ro AML", "Nhà đầu tư hoặc dòng tiền có dấu hiệu bất thường", 2, 5, "KYC/AML trước giao dịch; giám sát bất thường", "FutureBank"),
    ("Xung đột lợi ích của FutureBank", "Ngân hàng vừa cung cấp dịch vụ vừa có lợi ích trong sản phẩm", 2, 5, "Công bố vai trò; tách chức năng; quản trị xung đột", "FutureBank"),
]

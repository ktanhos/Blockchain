...
- Bộ xuất Word mới xây dựng bảng Word thật thay vì chuyển Markdown sang Word.
...
- Sơ đồ As-is, kiến trúc Blockchain, To-be, vòng đời token, Integrated Risk Heat Map và lộ trình triển khai được tạo tự động từ dữ liệu Case.
- Bảng tính tài chính, Term Sheet, lợi ích nhà đầu tư, Risk Register và Consistency Checker được đưa vào đúng chương và phụ lục.
